    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="lg:hidden fixed top-18 left-4 z-40 bg-gray-900 text-white p-3 rounded-full shadow-xl border border-gray-700 active:scale-95 transition-transform"
        >
          <Menu size={24} />
        </button>
      )}
