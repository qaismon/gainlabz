...
                                            className={`w-16 h-12 rounded overflow-hidden border ${mainImageIndex === i ? 'border-orange-500 ring-2 ring-orange-500' : ''}`}
                                        >
...
                                    <div className="mt-4">
                                        <div className="text-xl font-bold text-orange-600">{currency}{Number(activeProduct.price || 0).toFixed(2)}</div>
...
                                                className={`px-3 py-1 rounded-full border ${selectedFlavor === fl ? 'bg-orange-500 text-white border-orange-500' : 'bg-white text-gray-700'}`}
                                            >
                                                {fl}
                                            </button>
                                        ))}
