...
    
    const initialData = {
        name: '', price: '', description: '', category: '', subCategory: '', image: [], flavor: '', bestseller: false
    };
...
                flavor: productToEdit.flavor.join(', '),
            });
        } else {
...
            toast.error("Failed to update product. Check image file or server.");
        } finally {
            setLoading(false);
        }
    };
...
                    
                    <p className='text-sm text-gray-600 mb-2'>Existing Images ({data.image.length}): Click 'X' to remove.</p>
